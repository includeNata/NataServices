    ...
    <main className="h-screen w-screen py-36 flex items-center justify-start relative">
      <div className="w-[65%] h-auto flex flex-col gap-3 px-16">
        <div className="w-full flex flex-col gap-1">
          ...
          <span className="text-lg text-[#626262] font-semibold">Conecte-se com especialistas em diversas áreas e contrate serviços de alta qualidade com facilidade e segurança</span>
        </div>

        <button className="w-fit bg-[#1D4ED8] px-6 py-3 text-white text-xl rounded-lg">
          Procurar Serviços
        </button>
      </div>
